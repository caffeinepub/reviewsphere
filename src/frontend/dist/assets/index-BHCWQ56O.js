...
const BookOpenCheck = createLucideIcon("book-open-check", __iconNode$k);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Footer({ onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-primary text-primary-foreground mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 bg-white/20 rounded-md flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpenCheck, { size: 20, className: "text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl", children: "ReviewSphere" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-sm leading-relaxed", children: "India's premier structured book review platform for BBA and MBA management students. Academic rigour meets practical insight." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-lg mb-4", children: "Quick Links" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-lg mb-4", children: "About ReviewSphere" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-primary-foreground/75", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "📍 Ahmedabad, Gujarat, India" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "🎓 Designed for BBA/MBA Students" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "📚 SWOT-Based Review Methodology" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "🏛️ Academic Assignment Compliant" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "🇮🇳 India-Focused Content" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/20 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-primary-foreground/60", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "© ",
        year,
        " ReviewSphere. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
...
function Navbar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-border shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 bg-primary rounded-md flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpenCheck, { size: 20, className: "text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-primary text-lg leading-none block", children: "ReviewSphere" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground leading-none", children: "BBA Management Reviews" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-6", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: menuOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 20 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { size: 20 })
          }
        )
      ] })
    ] }),
    menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden border-t border-border py-3 space-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "text",
          placeholder: "Search books...",
      ...
      navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          "data-ocid": `nav.${item.id}.link`,
          className: `w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors ${currentPage === item.id ? "bg-primary/10 text-primary" : "text-foreground hover:bg-muted"}`,
          onClick: () => {
            onNavigate(item.id);
            setMenuOpen(false);
          },
...
function AboutUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-primary text-primary-foreground py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary-foreground/60 mb-3 block", children: "Our Story" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl md:text-5xl font-bold leading-tight mb-5", children: [
        "Built by Educators,",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "For Students" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg leading-relaxed", children: "ReviewSphere was born out of frustration — the lack of structured, India-relevant academic book analysis for management students navigating crowded syllabi and demanding placements." })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary rounded-xl p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary mb-5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-4", children: "Our Mission" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "To provide every BBA and MBA student in India with access to structured, SWOT-based book reviews that develop critical thinking, support academic achievement, and bridge the gap between management theory and India's lived business reality." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/5 border border-primary/20 rounded-xl p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary mb-5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-4", children: "Our Vision" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "To become India's most trusted academic book review platform — a resource cited in B-school syllabi, referenced in management research, and relied upon by the next generation of Indian business leaders across all 28 states." })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-secondary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-10 text-center", children: "Our Core Values" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: values.map(({ icon: Icon2, title, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "text-center p-6 bg-white rounded-xl border border-border shadow-sm",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, className: "text-primary" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary/60 mb-2 block", children: "The People Behind ReviewSphere" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-primary", children: "Meet Our Team" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: team.map((member) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex gap-4 p-5 rounded-xl border border-border bg-background hover:shadow-card transition-shadow items-center",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-sm text-primary-foreground", children: member.initials }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-sm", children: member.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary font-medium", children: member.role })
            ] })
          ]
        },
        member.name
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-secondary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-4", children: "🇮🇳 Proudly India-Based" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-2xl mx-auto leading-relaxed", children: "ReviewSphere is headquartered in Ahmedabad, Gujarat — one of India's fastest-growing business hubs and home to a thriving academic community. Our editorial team spans major cities across India. All reviews are written with the Indian regulatory environment, academic curriculum (CBCS/NEP 2020), and business landscape in mind." })
    ] }) })
  ] });
}
const tiers = [
...
function BusinessModel() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary/50 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary/60 mb-2 block", children: "Platform Economics" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "section-title", children: "Business Model" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle max-w-2xl", children: "ReviewSphere operates as a freemium academic platform with a clear India-first pricing strategy, making quality management education accessible at every level." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-6", children: "Value Proposition" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose prose-sm max-w-none text-muted-foreground leading-relaxed space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "ReviewSphere addresses a clear gap in India's academic publishing ecosystem: the absence of structured, analytically rigorous book reviews designed specifically for undergraduate management students. Traditional book summaries lack the critical depth required for BBA coursework, while academic journals are inaccessible to most students." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Our platform democratises analytical thinking by providing SWOT-based reviews that bridge textbook theory with India's real business environment — covering sectors from FMCG and banking to IT services and public sector enterprises." })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-secondary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-10 text-center", children: "Pricing Tiers" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: tiers.map((tier) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `rounded-xl border overflow-hidden ${tier.highlight ? "border-primary shadow-card ring-2 ring-primary/20" : "border-border bg-white shadow-sm"}`,
          children: [
            tier.highlight && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary text-primary-foreground text-center py-2 text-xs font-bold uppercase tracking-widest", children: "⭐ Most Popular" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `p-6 ${tier.highlight ? "bg-white" : ""}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground", children: tier.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-4", children: tier.target }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-1 mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-4xl text-primary", children: tier.price }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-muted-foreground mb-1", children: [
                  "/",
                  tier.period
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: tier.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleCheckBig,
                  {
                    size: 15,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-8", children: "Revenue Streams" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5", children: revenueStreams.map(({ icon: Icon2, title, desc, pct }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 18, className: "text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-foreground text-sm", children: title })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-2xl text-primary/30", children: pct })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: desc })
          ]
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold mb-4", children: "India-First Market Strategy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 leading-relaxed mb-6", children: "India has over 5,000 management colleges with approximately 3.5 lakh BBA students enrolled annually. ReviewSphere targets tier-1 and tier-2 city institutions where digital adoption is highest and academic rigor is prioritized." }),
        ...
        ].map(({ value, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/10 rounded-lg p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-2xl", children: value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-primary-foreground/70 mt-0.5", children: label })
        ] }, label)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-xl mb-4", children: "Target Cities" }),
        [
        ...
        ].map(([city, desc]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            IndianRupee,
            {
              size: 14,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm", children: city }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary-foreground/60 text-xs", children: [
            "— ",
            desc
          ] })
        ] }, city))
...
const books = [
  {
    ...
    category: "Strategy",
    rating: 4,
    summary: "An analysis of India's rise as an economic superpower, examining policy, demographics, and global positioning.",
  ...
  },
  {
    ...
    category: "Finance",
    rating: 5,
    summary: "A foundational text on financial management tailored for Indian markets, regulatory frameworks, and SEBI guidelines.",
    publisher: "Tata McGraw-Hill",
    year: 2019,
    swot: {
      strengths: "Covers Indian regulatory frameworks including SEBI and RBI norms",
  ...
  },
  {
    ...
    category: "Marketing",
    rating: 5,
    summary: "The definitive guide to marketing strategy adapted for South Asian markets, with Indian brand case studies.",
    ...
    swot: {
      ...
      opportunities: "Applicable to both startups and established MNCs in India",
      threats: "Digital marketing chapters lag behind current social media trends"
    },
    top: true
  },
  {
    ...
    category: "HR",
    rating: 4,
    summary: "Comprehensive HR framework enriched with Indian organisational examples from IT, banking, and manufacturing sectors.",
    publisher: "Pearson India",
    year: 2018,
    swot: {
      strengths: "Real Indian HR scenarios including TCS, Infosys workforce examples",
      weaknesses: "Some US-centric content not directly applicable to Indian labour law",
      opportunities: "Highly useful for HR professionals and campus placement preparation",
  ...
  },
  {
    ...
    category: "Strategy",
    rating: 4,
    summary: "Porter's five forces and competitive frameworks applied to India's unique competitive landscape and sector dynamics.",
    publisher: "Free Press India",
    year: 2015,
    swot: {
      strengths: "Timeless strategic models tested across global and Indian contexts",
      ...
      threats: "Global framework focus sometimes overshadows local market realities"
    },
    top: true
  },
  {
    ...
    category: "Finance",
    rating: 4,
    summary: "Practical guide to investment analysis focused on NSE and BSE markets, Sensex trends, and Indian investor behaviour.",
    publisher: "Vikas Publishing",
    year: 2017,
    swot: {
      strengths: "NSE/BSE focused examples with Indian equity and bond market data",
      weaknesses: "Assumes prior basic finance knowledge — not suitable for beginners",
      opportunities: "Highly relevant for students pursuing CFA or NISM certifications",
  ...
  },
  {
    ...
    category: "Marketing",
    rating: 3,
    summary: "Explores consumer psychology with Indian buying behaviour insights across urban and semi-urban demographics.",
    publisher: "Cengage India",
    year: 2016,
    swot: {
      strengths: "Strong theoretical base grounded in social psychology research",
      ...
      threats: "Social media and influencer marketing impact significantly understated"
    },
    top: false
  },
  {
    ...
    category: "HR",
    rating: 5,
    summary: "Behaviour in organisations explained through Indian workplace culture, hierarchy, and motivation frameworks.",
    publisher: "Pearson India",
    year: 2019,
    swot: {
      strengths: "Indian workplace examples including family-owned firms and MNC subsidiaries",
      weaknesses: "Some topics overlap with Human Resource Management textbooks",
      opportunities: "Excellent resource for campus placement group discussion preparation",
      threats: "Rapidly changing workplace norms post-pandemic need new edition"
    },
    top: true
  },
  {
    ...
    category: "Strategy",
    rating: 3,
    summary: "Entry-level strategy text ideal for first-year BBA students, covering PESTLE, Porter, and BCG matrix fundamentals.",
    publisher: "Oxford India",
    year: 2014,
    swot: {
      strengths: "Simple, accessible language suitable for undergraduate beginners",
      weaknesses: "Lacks analytical depth required for advanced strategy electives",
      opportunities: "Serves as a solid conceptual foundation for MBA-level study",
      threats: "Case studies are outdated — mostly pre-2010 Indian corporate examples"
    },
    top: false
  },
  {
    ...
    category: "Marketing",
    rating: 4,
    summary: "Covers Indian sales force management, channel distribution, and retail trade with FMCG sector focus.",
    publisher: "Tata McGraw-Hill",
    year: 2018,
    swot: {
      strengths: "Highly India-specific with regional distributor and channel examples",
      weaknesses: "Narrow focus on traditional trade limits applicability to all sectors",
      opportunities: "Ideal for students targeting FMCG, retail, and distribution careers",
...
function StarRating({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5", children: stars.map((starNum) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Star,
    {
      size,
      className: starNum <= rating ? "star-filled fill-current" : "star-empty"
    },
    starNum
  )) });
}
function BookCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      "data-ocid": `book.item.${index2}`,
      onClick: () => onClick == null ? void 0 : onClick(book),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-md bg-primary/10 flex items-center justify-center mb-3 group-hover:bg-primary/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 20, className: "text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground leading-snug text-base line-clamp-2", children: book.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: book.author })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `category-badge ${categoryColors[book.category]}`, children: book.category }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { rating: book.rating, size: 14 }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed line-clamp-3", children: book.summary }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-3 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: book.publisher }),
            showYear && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "·" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: book.year })
            ] })
          ] })
        ] })
      ]
...
const FILTERS = ["All", "Marketing", "Finance", "HR", "Strategy"];
function Categories({ searchQuery }) {
  const [activeFilter, setActiveFilter] = reactExports.useState("All");
  const filtered = books.filter((b) => {
    const matchesCategory = activeFilter === "All" || b.category === activeFilter;
    const matchesSearch = !searchQuery || b.title.toLowerCase().includes(searchQuery.toLowerCase()) || b.author.toLowerCase().includes(searchQuery.toLowerCase()) || b.summary.toLowerCase().includes(searchQuery.toLowerCase());
    return matchesCategory && matchesSearch;
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary/60 mb-2 block", children: "Browse Collection" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "section-title", children: "Book Categories" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle max-w-2xl", children: "Explore our curated collection of management books organised by discipline. Filter by category to find reviews most relevant to your coursework." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-8", children: ["Marketing", "Finance", "HR", "Strategy"].map(
      (cat) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `rounded-lg p-4 text-left border transition-all ${activeFilter === cat ? "border-primary bg-primary/5 shadow-sm" : "border-border bg-white hover:border-primary/30"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-2xl text-primary", children: count }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "books reviewed" })
            ]
          },
          cat
        );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-8", children: FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        "data-ocid": "categories.filter.tab",
        onClick: () => setActiveFilter(f),
        className: `px-4 py-2 rounded-full text-sm font-medium transition-all ${activeFilter === f ? "bg-primary text-primary-foreground shadow-sm" : "bg-white border border-border text-foreground hover:border-primary/40"}`,
        children: f
      },
      f
    )) }),
    filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-20", "data-ocid": "categories.empty_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        BookOpen,
        {
          size: 48,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl text-muted-foreground", children: "No books found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-2", children: "Try adjusting your search or filter criteria." })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-6", children: [
        ...
        activeFilter !== "All" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          "in",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: activeFilter })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5", children: filtered.map((book, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(BookCard, { book, index: i + 1 }, book.id)) })
    ] })
  ] });
}
...
function ContactUs() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary/50 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary/60 mb-2 block", children: "Get in Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "section-title", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle max-w-xl", children: "Have a book recommendation, institutional enquiry, or academic partnership proposal? We'd love to hear from you." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-3", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 32, className: "text-green-600" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-primary mb-3", children: "Message Sent!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-sm", children: "Thank you for reaching out. Our editorial team will respond within 2–3 working days." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "outline",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-primary mb-6", children: "Contact Information" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-5", children: [
            {
              icon: MapPin,
              label: "Address",
              value: "ReviewSphere Editorial Office\nSG Highway, Ahmedabad\nGujarat 380054, India"
            },
            {
              icon: Mail,
              label: "Email",
          ...
          ].map(({ icon: Icon2, label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 bg-primary/10 rounded-md flex items-center justify-center flex-shrink-0 mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16, className: "text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground whitespace-pre-line", children: value })
            ] })
          ] }, label)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary rounded-xl p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-foreground mb-3", children: "For Academic Institutions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Interested in an institutional licence for your college? Our team offers customised packages for universities and autonomous B-schools across India. Contact us with your institution details for a tailored proposal." })
        ] })
      ] })
    ] }) }) })
  ] });
...
function Home({ onNavigate }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative bg-primary overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-white/15 rounded-full px-4 py-1.5 text-sm text-white/90 font-medium mb-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-accent", children: "Sharper Minds" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-lg md:text-xl leading-relaxed mb-8 max-w-2xl", children: "ReviewSphere provides BBA and MBA students across India with analytically rigorous, SWOT-based book reviews across Marketing, Finance, HR, and Strategy domains." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary/60 mb-3 block", children: "Who We Are" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "A Knowledge Platform Built for India's Future Business Leaders" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle", children: "ReviewSphere is an academic review platform founded by management educators and BBA alumni to address the gap in structured, India-contextualised book analysis for undergraduate students." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base leading-relaxed mt-4", children: "We believe every management student deserves access to high-quality, analytically structured book reviews that go beyond mere summaries — connecting theory to India's dynamic business landscape." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: [
        {
          icon: BookOpen,
      ...
      ].map(({ icon: Icon2, label, value, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary rounded-lg p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, className: "text-primary mb-2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-2xl text-primary", children: value }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-secondary/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
      {
        title: "What We Do",
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-primary mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-xl text-primary mb-3", children: item.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: item.body })
        ]
      },
      item.title
    )) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary/60 mb-2 block", children: "Curated Selection" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "Featured Reviews" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: featuredBooks.map((book, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        BookCard,
        {
          book,
          index: i + 1,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 sm:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          variant: "outline",
          className: "w-full",
...
const swotItems = [
  {
    ...
    description: "Core positive attributes of the book — academic rigour, relevance, India-specific content, clarity of concepts."
  },
  {
    key: "weaknesses",
    label: "Weaknesses",
    ...
    description: "Limitations or shortcomings — outdated data, narrow scope, US/Western bias, excessive jargon."
  },
  {
    key: "opportunities",
    label: "Opportunities",
    ...
    description: "Learning outcomes and career applications — which roles, sectors, or academic paths benefit most."
  },
  {
    key: "threats",
    label: "Threats",
    ...
    description: "Risk factors for students relying solely on this text — gaps, competing resources, obsolescence risk."
  }
];
const steps = [
  {
...
const sampleBook = books[2];
function ReviewFramework() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary/50 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary/60 mb-2 block", children: "Methodology" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "section-title", children: "Review Framework" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle max-w-2xl", children: "Our structured SWOT-based methodology ensures every book review goes beyond a summary — delivering analytical insight that supports academic work and critical thinking." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-8", children: "The SWOT Review Model" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5", children: swotItems.map(
        ({ key, label, icon: Icon2, color, iconColor, description }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-xl p-6 border ${color}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, className: iconColor }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg", children: label })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed opacity-80", children: description })
        ] }, key)
      ) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-secondary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-10 text-center", children: "Our 5-Step Review Process" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block absolute top-6 left-0 right-0 h-0.5 bg-border" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-5 gap-6", children: steps.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary text-primary-foreground font-display font-bold text-lg flex items-center justify-center mx-auto mb-4 relative z-10", children: step.num }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm text-foreground mb-2", children: step.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: step.desc })
        ] }) }, step.num)) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-8", children: "Star Rating Criteria" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 max-w-2xl", children: [
        {
          stars: 5,
          label: "Exceptional",
      ...
      ].map(({ stars, label, desc }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-start gap-4 p-4 rounded-lg border border-border bg-background",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { rating: stars, size: 16 }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground", children: label }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground text-sm ml-2", children: [
                "— ",
                desc
              ] })
            ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14 bg-secondary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-primary mb-8", children: "Sample Structured Review" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-xl border border-border shadow-card overflow-hidden max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary px-6 py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 22, className: "text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-white", children: sampleBook.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm mt-0.5", children: sampleBook.author }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { rating: sampleBook.rating, size: 15 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `category-badge ${categoryColors[sampleBook.category]}`,
                  children: sampleBook.category
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-white/60 text-xs", children: [
                sampleBook.publisher,
                " · ",
                sampleBook.year
              ] })
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-6", children: sampleBook.summary }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: swotItems.map(
            ({ key, label, icon: Icon2, color, iconColor }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-lg p-4 border ${color}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 15, className: iconColor }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-xs uppercase tracking-wide", children: label })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs leading-relaxed opacity-80", children: sampleBook.swot[key] })
            ] }, key)
          ) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14, className: "text-green-600" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Review follows ReviewSphere SWOT Methodology v2.0" })
        ] }) })
      ] })
    ] }) })
  ] });
...
const swotIconMap = {
  ...
  threats: { icon: TriangleAlert, color: "text-amber-600" }
};
function TopRecommendations() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary/50 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { size: 28, className: "text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary/60", children: "Editor's Choice" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "section-title", children: "Top Recommendations" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subtitle max-w-2xl", children: "Our highest-rated management books — curated by the ReviewSphere editorial board for academic excellence and India-market relevance." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: topBooks.map((book, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-primary text-sm", children: [
                  "#",
                  index2 + 1
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg text-foreground leading-tight", children: book.title }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-0.5", children: book.author })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-shrink-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { rating: book.rating, size: 16 }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mt-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: book.publisher }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "·" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: book.year }),
                    book.rating === 5 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent/20 text-accent-foreground text-xs", children: "⭐ Top Rated" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mt-3", children: book.summary })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  BookOpen,
                  {
          ...
          expanded === book.id && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pb-6 border-t border-border pt-5 bg-secondary/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm text-primary mb-4", children: "SWOT Analysis" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: Object.entries(book.swot).map(([key, value]) => {
              const { icon: Icon2, color } = swotIconMap[key];
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wide text-foreground/60", children: key }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed mt-1", children: value })
                    ] })
                  ]
                },
                key
...
function App() {
  ...
  function renderPage() {
    switch (currentPage) {
      case "home":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Home, { onNavigate: handleNavigate });
      case "categories":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Categories, { searchQuery });
      case "framework":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewFramework, {});
      case "recommendations":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(TopRecommendations, {});
      case "business":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(BusinessModel, {});
      case "about":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(AboutUs, {});
      case "contact":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ContactUs, {});
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Home, { onNavigate: handleNavigate });
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1", children: renderPage() }),
...
field ${k} -> ${e.message}`);
  ...
  encodeValue(x) {
    const values2 = this._fields.map(([key]) => x[key]);
    const bufs = zipWith(this._fields, values2, ([, c], d) => c.encodeValue(d));
    return concat(...bufs);
  }
  ...
  valueToString(x) {
    const values2 = this._fields.map(([key]) => x[key]);
    const fields = zipWith(this._fields, values2, ([k, c], d) => k + "=" + c.valueToString(d));
    return `record {${fields.join("; ")}}`;
  }
}
